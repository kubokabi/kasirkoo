        ...
        <div class="card-body">
          ...
          <div class="text-end">
            <button
              ...
              class="btn btn-sm btn-danger btn-md border-0 shadow text-uppercase mt-3 me-2"
              :disabled="!product.id"
            >
            ...
            <button
              ...
              class="btn btn-sm btn-success btn-md border-0 shadow text-uppercase mt-3"
              :disabled="!product.id"
            >
        ...
        <div class="card-body">
          ...
          <div class="text-end mt-4">
            ...
            <button
              ...
              class="btn btn-sm btn-success btn-md border-0 shadow text-uppercase mt-3 me-2"
